  ...
  return (
    <section>
      <div className="m-auto">
        <blockquote key="hbcd" id="hbcd" className="relative block ">
          <BsQuote className="text-slate-200 text-8xl dark:text-blue-300/70" />
          <p className="absolute top-8 left-14 inline-block text-3xl">
          สาร HBCD 
          </p>
        </blockquote>
      </div>
